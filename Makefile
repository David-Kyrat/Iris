...
DIR_SETUP=/*.scala setupIris/*/*.scala
DIR_LIB=lib/*/*.scala
DIR_MISC=misc/*.scala
...
fatjar: iris_fatjar _fatjar misc_flatpak_fatjar

iris_fatjar:
	scala-cli --power package iris lib --assembly --preamble=false --jvm 11 -f -o iris.jar

setup_fatjar:
	scala-cli --power package  lib --assembly --preamble=false --jvm 11 -f -o setup_iris-java.jar
...
bootstrap_jar:
	scala-cli --power package iris lib --assembly -o iris.jar && scala-cli --power package  lib --assembly -o setup_iris.jar && scala-cli --power package misc lib --assembly -o setup_iris.jar

bootstrap_jar_nodep:
	scala-cli --power package iris lib -o iris.jar && scala-cli --power package  lib -o setup_iris.jar
